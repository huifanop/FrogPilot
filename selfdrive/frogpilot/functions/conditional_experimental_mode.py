...
########################################################################
    ...
    ########################################################################
    condition_met = self.check_conditions(carState, frogpilotNavigation, lead, lead_distance, modelData, speed_difference, standstill, v_ego, v_lead, v_offset, v_ego_kph, emergencyslow,dvratio)
    ########################################################################
...
##################################################################
  def check_conditions(self, carState, frogpilotNavigation, lead, lead_distance, modelData, speed_difference, standstill, v_ego, v_lead, v_offset, v_ego_kph, emergencyslow, dvratio):
##################################################################
    if standstill:
