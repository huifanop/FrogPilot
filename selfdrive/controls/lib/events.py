...
def startup_master_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return StartupAlert("~新年快樂 祝您闔家歡樂 行車平安 旅途愉快~", "From FrogPilot 🐸 & HFOP", alert_status=AlertStatus.frogpilot)
...
###############################
  ...
  #     "",
  #     AlertStatus.userPrompt, AlertSize.full,
  #     Priority.HIGHEST, VisualAlert.none, AudibleAlert.warningSoft, 1.),
  # },
...
###############################
 ...
 # ********** events only containing alerts that display while engaged **********
  ...
  EventName.gpsMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("GPS故障", "可能硬體有問題"),
  },
