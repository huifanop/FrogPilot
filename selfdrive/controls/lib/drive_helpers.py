...
###################################################################################################
    if button_type == ButtonType.accelCruise and cruise_standstill or self.mem_params.get_bool('KeyResume'):
      self.mem_params.put_bool('KeyChanged', False)     
...
###################################################################################################
    if not self.button_change_states[button_type]["enabled"] or self.mem_params.get_bool('KeyResume'):  
      self.mem_params.put_bool('KeyChanged', False)  
      self.mem_params.put_bool('KeyResume', False)  
###################################################################################################   
      return
