...
####################################
  def update(self, pt_cp, body_cp, cam_cp, ext_cp, trans_type, frogpilot_variables):
    if self.start:
...
####################################    
    ...
    # print(" usetimeout=", self.usetimeout)
    # print(" 原始=", self.initial_Tank)
    # print(" 現在=", self.current_Tank)
    # print(" 使用=", self.usefuel_Tank)
    # self.oiltemperature = pt_cp.vl["Getriebe_14"]["GE_Sumpftemperatur"]
    # ret.oiltemperature = self.oiltemperature
####################################
